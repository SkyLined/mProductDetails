...
from mProductDetails.cLicenseServer import cLicenseServer;
...
def fuCheck(sMainScriptName, sFeatureName, asArguments, dsArguments):
  ...
  for oLicense in aoLicenses:
    ...
    oLicenseCheckResult = oLicenseServer.foGetLicenseCheckResult(oLicense, bCheckOnly = True);
